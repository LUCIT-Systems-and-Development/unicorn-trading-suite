...
security-check() {
    ...
    echo "https://github.com/LUCIT-Systems-and-Development/unicorn-trading-suite/actions/workflows/build_wheels.yml"
    echo "https://github.com/LUCIT-Systems-and-Development/unicorn-trading-suite/actions/workflows/build_conda.yml"
}
