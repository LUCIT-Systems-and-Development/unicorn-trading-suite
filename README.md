...
| **WebSocket Streams**                    | Yes, including new WebSocket trading API for orders and trading commands | Yes, for market data and user data streams                                  | Yes, including new WebSocket trading API for orders and trading commands                              | Yes, CCXT Pro                                                                 | 
